...
//!	Generated Date	: Wed, 12, Jul 2023  
	File Path	: DefaultComponent\SGCS\SGCS.h
*********************************************************************/
...
public :
    ...
    //## auto_generated
    const Garbage_Disposal_Sites::Software_Controllers* getItsSoftware_Controllers(void) const;
...
private :
    ...
    Garbage_Disposal_Sites::Software_Controllers itsSoftware_Controllers;		//## classInstance itsSoftware_Controllers
