...
part_0.obj : part_0.cpp part_0.h    BDD.h 
	$(CREATE_OBJ_DIR)
...
block_39.obj : block_39.cpp block_39.h    BDD.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"block_39.obj" "block_39.cpp" 
...
Citizen.obj : Citizen.cpp Citizen.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Citizen.obj" "Citizen.cpp" 



Admin.obj : Admin.cpp Admin.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Admin.obj" "Admin.cpp" 



Driver.obj : Driver.cpp Driver.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Driver.obj" "Driver.cpp" 



BDD.obj : BDD.cpp BDD.h    Garbage_Bin.h Communication_System.h Dispatch.h Truck.h Weight_sensor.h Volume_sensor.h Data_Storage.h Analyzer.h GPS.h Main_Server.h Temperature_sensor.h Web_Dashboard.h SGCS.h Garbage_Disposal_Sites.h Truck_refuel_stations.h Users.h Electricity_provider.h block_39.h Recycling_center.h Software_Controllers.h UC_Collect_garbage.h UC_Plan_route.h UC_System_overview.h UC_Citizen_check_fill_level.h UC_Citizen_deposit_garbage.h part_0.h 
	$(CREATE_OBJ_DIR)
...
clean:
	...
	if exist block_39.obj erase block_39.obj
	...
	if exist Citizen.obj erase Citizen.obj
